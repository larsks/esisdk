...
The :class:`esi.resource.Resource` class is a base
...
are of a component type, including :class:`esi.resource.Body`,
:class:`esi.resource.Header`, and :class:`esi.resource.URI`.

For update management, :class:`esi.resource.Resource` employs
a series of :class:`esi.resource._ComponentManager` instances
...
from esi import warnings as os_warnings
...
class Resource(dict):
    ...
    name = Body("name")
    #: The ESI location of this resource.
    ...
    def __init__(self, _synchronized=False, connection=None, **attrs):
        ...
        :param bool _synchronized:
            ...
            :meth:`~esi.resource.Resource.new` and
            :meth:`~esi.resource.Resource.existing`.
        :param esi.connection.Connection connection:
    ...
    def _from_munch(cls, obj, synchronized=True, connection=None):
        ...
        Munch objects and original esisdk resources.
    ...
    def to_dict(
        ...
        :param bool body: Include the :class:`~esi.resource.Body`
            attributes in the returned dictionary.
        :param bool headers: Include the :class:`~esi.resource.Header`
            attributes in the returned dictionary.
        :param bool computed: Include the :class:`~esi.resource.Computed`
            attributes in the returned dictionary.
    ...
    def _get_session(cls, session):
        ...
        raise ValueError(
            ...
            " instance of an esi.proxy.Proxy object or at the very least"
    ...
    def _assert_microversion_for(
        ...
        :raises: :exc:`~esi.exceptions.NotSupported` if the version
    ...
    def create(
        ...
        **params,
        ...
        :param str base_path: Base part of the URI for creating resources, if
            different from :data:`~esi.resource.Resource.base_path`.
        ...
        :raises: :exc:`~esi.exceptions.MethodNotSupported` if
    ...
    def fetch(
        ...
        **params,
        ...
        :raises: :exc:`~esi.exceptions.ResourceNotFound` if
    ...
    def head(self, session, base_path=None, *, microversion=None):
        ...
        :raises: :exc:`~esi.exceptions.ResourceNotFound` if the resource
            was not found.
        """
    ...
    def list(
        ...
        **params,
        ...
        :param dict params: These keyword arguments are passed through the
            :meth:`~esi.resource.QueryParamter._transpose` method
            ...
            checked against the :data:`~esi.resource.Resource.base_path`
        ...
        :raises: :exc:`~esi.exceptions.InvalidResourceQuery` if query
    ...
    def find(
        ...
        **params,
        ...
        :param bool ignore_missing: When set to ``False``
            :class:`~esi.exceptions.ResourceNotFound` will be raised when
        ...
        :param dict params: Any additional parameters to be passed into
            ...
            :meth:`~esi.resource.Resource.existing` in order to pass on
            URI parameters.

        :return: The :class:`Resource` object matching the given name or id
            or None if nothing matches.
        :raises: :class:`esi.exceptions.DuplicateResource` if more
            than one resource is found for this request.
        :raises: :class:`esi.exceptions.ResourceNotFound` if nothing
        ...
        try:
            ...
            # NOTE(gtema): There are few places around esi that return
...
def wait_for_status(
    ...
    :type resource: :class:`~esi.resource.Resource`
    ...
    :raises: :class:`~esi.exceptions.ResourceTimeout` transition
        to status failed to occur in wait seconds.
    :raises: :class:`~esi.exceptions.ResourceFailure` resource
